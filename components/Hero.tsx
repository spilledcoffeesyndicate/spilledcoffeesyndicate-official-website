  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-24 pb-16">
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        <Lightning hue={270} speed={0.5} intensity={0.5} size={0.8} />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          MVP Development in{' '}
          <span className="text-accent-400 font-mono">48 Hours</span>
        </motion.h1>
        ...
        >
          We ship a launch-ready MVP with pre-agreed scope in 48 hours,
          so you can validate fast. Fixed price. No surprises.
        </motion.p>
        ...
        >
          <ElectricBorder color="#8b5cf6" borderRadius={4} className="inline-block">
            <a
              href="#calendly"
              className="block px-6 py-3 bg-transparent text-white font-mono font-medium hover:bg-white/10 transition border-0"
            >
              Book 15-min Call
            </a>
          </ElectricBorder>
          <ElectricBorder color="#ffffff" borderRadius={4} className="inline-block">
            <a
              href="#calculator"
              className="block px-6 py-3 bg-white text-black font-mono font-medium hover:bg-white/90 transition"
            >
              Get Free Estimate
            </a>
          </ElectricBorder>
