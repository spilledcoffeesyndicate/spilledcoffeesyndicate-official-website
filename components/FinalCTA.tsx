      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-white/70 mb-8 max-w-2xl mx-auto">
            Get a free estimate or book a 15-min call. No upfront payment required.
            Cancel anytime before we start.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <a
              href="#calculator"
              className="px-6 py-3 bg-white text-black font-mono font-medium hover:bg-white/90 transition"
            >
              Calculate Price
            </a>
            <a
              href="#calendly"
              className="px-6 py-3 border-2 border-white text-white font-mono font-medium hover:bg-white/10 transition"
            >
              Book 15-min Call
            </a>
          </div>
          ...
          <div className="aspect-[4/3] w-full max-w-xl max-h-[500px] bg-white/5 border border-white/10 rounded-lg flex items-center justify-center mx-auto">
            <div className="flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-sm text-white/50 mb-6">
                Add your Calendly embed URL or iframe here
              </p>
              <a
              ...
              >
                <span className="inline-flex items-center gap-2">Book via Calendly <ArrowRight className="w-4 h-4" strokeWidth={2} /></span>
              </a>
            </div>
          </div>
        </motion.div>
